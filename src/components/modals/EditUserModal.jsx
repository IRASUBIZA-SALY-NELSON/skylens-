...
const EditUserModal = ({ isOpen, onClose, user, onSuccess, context = 'admin' }) => {
  ...
  const roles = [
    ...
    { id: 3, name: 'Sales Manager', value: 'SALES_MANAGER' },
    { id: 4, name: 'Sales Assistant', value: 'SALES_ASSISTANT' },
    { id: 5, name: 'Store Manager', value: 'STORE_MANAGER' },
    { id: 6, name: 'Warehouse Manager', value: 'WAREHOUSE_MANAGER' },
    { id: 7, name: 'Accountant', value: 'ACCOUNTANT' },
    { id: 8, name: 'Distributor', value: 'DISTRIBUTOR' },
    { id: 9, name: 'Managing Director', value: 'MANAGING_DIRECTOR' },
    { id: 10, name: 'Super Admin', value: 'SUPER_ADMIN' },
    { id: 11, name: 'User', value: 'USER' },
    { id: 12, name: 'Tenant', value: 'TENANT' },
  ]
      ...
      <div className="bg-white rounded-lg w-full max-w-[1200px] mx-4 h-[815px]">
        ...
        <form onSubmit={handleSubmit}>
          <div className="p-6">
            ...
            {activeTab === 'professional' && userRole === 'ADMIN' && (
              <div className="space-y-6 overflow-y-auto h-[500px]">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
